...
namespace RotaryHeart.Lib.SerializableDictionary
{
    ...
    public class DictionaryPropertyDrawer : PropertyDrawer
    {
        ...
        GUIStyle tooTipStyle = new GUIStyle("Tooltip");
        ...
        public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
        {
            ...
            float defaultHeight = lineHeight;

            // Default height 20, fixes excessive expansion. 
            float height = defaultHeight;

            if (keys.arrayElementType.Contains("$")) height += 20; // + height instead of absolute value.
            ...
            if (property.isExpanded)
            {
                ...
                else height += 36; // Default height for empty list. 
            }
        ...
        private float PropertyChildHeight(SerializedProperty prop)
        {
            ...
            switch (prop.propertyType)
            {
                case SerializedPropertyType.Generic:
                    height = Mathf.Max(EditorGUI.GetPropertyHeight(prop, GUIContent.none, true), 25);
                    break;
                default:
                    height = 29;
                    break;
        ...
        private float List_getElementHeightCallback(SerializedProperty element, int index)
        {
            ...
            {
                case SerializedPropertyType.Generic:
                    height = Mathf.Max(EditorGUI.GetPropertyHeight(element, GUIContent.none, true), 25);
                    break;
            ...
            if (element.isExpanded)
            {
                ...
                {
                    case SerializedPropertyType.Generic:
                        height += Mathf.Max(EditorGUI.GetPropertyHeight(valueProp, GUIContent.none, true), 25);
                        break;
                    default:
                        height += 25;
                        break;
